...
namespace Tarsashaz.Migrations
{
    ...
    [Migration("20200929065110_SeedConfigTest")]
    partial class SeedConfigTest
    {
            ...
            modelBuilder.Entity("Tarsashaz.Models.Bills.BillDate", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            BillId = 1,
                            Deadline = new DateTime(2020, 9, 29, 8, 51, 9, 508, DateTimeKind.Local).AddTicks(993),
                            PayoffEnd = new DateTime(2020, 9, 29, 8, 51, 9, 508, DateTimeKind.Local).AddTicks(588),
                            PayoffStart = new DateTime(2020, 9, 29, 8, 51, 9, 508, DateTimeKind.Local).AddTicks(168),
                            StartDate = new DateTime(2020, 9, 29, 8, 51, 9, 507, DateTimeKind.Local).AddTicks(9702)
                        });
                });
            ...
            modelBuilder.Entity("Tarsashaz.Models.Condominiums.Announcement", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CondominiumId = 1,
                            Date = new DateTime(2020, 9, 29, 8, 51, 9, 504, DateTimeKind.Local).AddTicks(8828),
                            Priority = 2,
                            Range = 0,
                            SenderId = 1,
                            Text = "TestString"

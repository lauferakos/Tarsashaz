...
namespace Tarsashaz.Migrations
{
    ...
    [Migration("20200929062928_SeedDb")]
            ...
            modelBuilder.Entity("Tarsashaz.Models.Bills.BillDate", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            BillId = 1,
                            Deadline = new DateTime(2020, 9, 29, 8, 29, 27, 851, DateTimeKind.Local).AddTicks(3677),
                            PayoffEnd = new DateTime(2020, 9, 29, 8, 29, 27, 851, DateTimeKind.Local).AddTicks(3200),
                            PayoffStart = new DateTime(2020, 9, 29, 8, 29, 27, 851, DateTimeKind.Local).AddTicks(2760),
                            StartDate = new DateTime(2020, 9, 29, 8, 29, 27, 851, DateTimeKind.Local).AddTicks(2280)
                        });
                });
            ...
            modelBuilder.Entity("Tarsashaz.Models.Condominiums.Announcement", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CondominiumId = 1,
                            Date = new DateTime(2020, 9, 29, 8, 29, 27, 848, DateTimeKind.Local).AddTicks(2453),
                            Priority = 2,
                            Range = 0,
                            SenderId = 1,
                            Text = "TestString"
